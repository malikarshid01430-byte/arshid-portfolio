...
const BackgroundGridComponent = () => {
  ...
  return (
    <div className="fixed inset-0 -z-50 overflow-hidden bg-black">
      ...
      {/* Static PCB Circuit Lines - removed animations */}
      <svg className="absolute inset-0 h-full w-full opacity-15 stroke-cyan-500/30" xmlns="http://www.w3.org/2000/svg">
        <defs>
      ...
      {/* Static glowing nodes - removed pulse animation */}
